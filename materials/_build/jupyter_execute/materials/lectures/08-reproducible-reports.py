...
# ```
# 
# ### [`rmarkdown`](https://rmarkdown.rstudio.com/docs/reference/convert_ipynb.html)
# 
# In the R console, type:
# 
# ```
# rmarkdown::convert_ipynb("notebook.ipynb", output = xfun::with_ext("notebook", "Rmd"))
# ```
# 
...
# 
# ```
# jupytext notebook.Rmd --output notebook.ipynb
# ```
# 
