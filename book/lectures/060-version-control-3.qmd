...
4. Click on the Projects tab, and then click **"New project"**. Under **"Start from scratch"** select **"Board"** as the template option and give the project a name.

5. Use the **Open issues** in the repo to set-up a project board for the next two weeks (or more) of your DSCI 310 homework. For each issue you add to the project, assign it to yourself and add a label of "group-work" or "individual-work".
