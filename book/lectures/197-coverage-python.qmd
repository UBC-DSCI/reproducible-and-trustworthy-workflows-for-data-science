...
## Reporting coverage badges

<https://codecov.io/> is a service that can take our `pytest` information and
give us a visualization of our test coverage and also give us a badge we can display in our repository.
...
- setup code cov action
    ...
    - when CI runs you will see a link in that particular step results of the coverage with a URL (else you probably didn't have a token)
